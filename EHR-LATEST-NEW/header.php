...
<head>
    ...
    <script>
        // Check on page load if user was inactive for more than 5 seconds (including after browser close)
...
-            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="services.php"><i class="bi bi-capsule me-1"></i> Services</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
