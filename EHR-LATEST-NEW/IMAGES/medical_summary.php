...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderMedicalRecords(records) {
        const recordTypes = [
            ...
            { key: 'vitals', title: 'Vital Signs', icon: 'bi-heart-pulse', fields: ['recorded_by', 'bp', 'respiratory_rate', 'hr', 'temp', 'height', 'weight', 'oxygen_saturation', 'pain_scale', 'date_taken', 'time_taken', 'general_appearance'] },
